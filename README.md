...
| **Bremen** (HB) | ⛔ | – | – | – | – | – | – | Nur **PDF**-Verkehrsmengenkarten (älter); A/B via BASt-Backbone. |
...
| **Hessen** (HE) | ⛔ | – | – | – | – | – | – | Nur Viewer/PDF; Herausgabe maschinenlesbarer Daten verweigert. |
| **Mecklenburg-Vorpommern** (MV) | 🔍 | [Portal](https://www.geoportal-mv.de/) | – | (2015) | DTV | dl-de/by-2.0 | – | WFS-/SVZ-Endpunkt noch nicht verifiziert. |
...
| **Rheinland-Pfalz** (RP) | ⛔ | [OGC API](https://www.geoportal.rlp.de/spatial-objects/393) | – | 2021 | DTV | dl-de/by-2.0 | – | OGC API Features (`DTV_WFS:SVZ{Jahr}_Zaehlstellenbereiche`) vorhanden, Server liefert aber konstant **DB-Fehler** → warten. |
