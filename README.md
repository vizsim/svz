...
| **Niedersachsen** (NI) | ✅ | [ZIP](https://map.strassenbau.niedersachsen.de/zip/DE-NI-SBV_Downloadservice_SVZ_Zaehlstellenbereiche_2021.zip) | Linien | 2021 | DTV | CC-BY-4.0 | 2.819 | INSPIRE-Downloadservice-**ZIP** (Shapefile), EPSG:25832. Lizenz lt. INSPIRE-Record (CC BY 4.0). |
...
| **Saarland** (SL) | ✅ | [WFS](https://geoportal.saarland.de/arcgis/services/Internet/Verkehr_WFS/MapServer/WFSServer) | Punkte | 2021 | DTV | CC-BY-4.0 | 757 | Zählstellen als **Punkte** (ArcGIS); brauchte `srs=CRS:84` (EPSG:4326 tauschte lat/lon). |
